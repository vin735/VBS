...
@PostMapping("/deposit")
    ...
    t.setDescription("Rs" + obj.getAmount() + "Deposited succsesfully");
    t.setUserId(obj.getId());
    transactionRepo.save(t);
    return "Deposit Succsesfull";
}
    ...
    public String withdraw(@RequestBody TransactionDto obj)
    {
        ...
        t.setAmount(obj.getAmount());
        t.setCurrBalance(newBalance);
        t.setDescription("Rs"+obj.getAmount()+"withdrawal  succsesfully");
        t.setUserId(obj.getId());
        transactionRepo.save(t);
        return "Withdrawal Succsesfull";
